<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    echo "<script>alert('Data berhasil ditambahkan!');window.location.href='index.php?p=criteria'</script>";
  }
  ...
  <script src="assets/jquery.js"></script>
      <script>
        ...
        $("#btnAdd").click(function(){
          ...
          var scr = "<div class='col-md-12' style='margin-top:5px'><div class='col-md-8'><input type='text' class='form-control' placeholder='Deskripsi' name='"+ deskripsi +"' required></div><div class='col-md-4'><input type='text' class='form-control' placeholder='Nilai' name='"+ dataawal +"' required></div></div></div>";
