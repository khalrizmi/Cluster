      ...
      <div class="box box-primary">
        ...
        <form role="form" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">Data Awal</label>
              <input type="text" class="form-control input-lg" id="exampleInputEmail1" placeholder="Masukan Nilai" name="nilai" required value="<?= $data['nilai'] ?>">
            </div>
